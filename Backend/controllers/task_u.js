        ...
        if (wordPattern.test(username)) {
          ...
          const info = await transporter.sendMail({
            ...
            html:
              ...
              username +
              ` on ProCollab by just clicking the link given below :</p>
                        <a href=` +
              link +
              `>Click here</a>
                    </div>`,
      ...
      if (user) {
        ...
        const info = await transporter.sendMail({
          ...
          html:
            ...
            token +
            `. Use this password to log in. Please change this password after log in for your security.</p>
                </div>`,
        });
...
exports.deleteTalk = async (req, res) => {
  try {
    ...
    if (!channel) {
      ...
      const talkIndex = channel.talks.findIndex(
        (talk) => talk._id.toString() === talkId
      );

...
const CreateProject = () => {
  ...
  const handleTagChange = (selectedTag) => {
    if (!projectData.tags.includes(selectedTag)) {
      setProjectData({
        ...projectData,
        tags: [...projectData.tags, selectedTag],
      });
    }
  };
    ...
    if (selectedFiles && selectedFiles.length > 0) {
      ...
      await Promise.all(
        fileArray.map(async (file) => {
          ...
          const response = await fetch(
            "https://api.imgbb.com/1/upload?key=fc85d77221544f26553516a9bfd4a285",
            {
              method: "POST",
              body: photos,
            }
      ...
      setProjectData({
        ...projectData,
        photos: [...projectData.photos, ...base64Array],
      });
    }
  };
    ...
    <>
      ...
      <div className={CreateProjectCss.wrapper}>
        <div className={CreateProjectCss.createprojectbox}>
              ...
              {projectData.tags.map((tag, index) => (
                <div key={index} className={CreateProjectCss.tag}>
                  ...
                  <AiOutlineCloseCircle
                    className={CreateProjectCss.removeicon}
          ...
          <div className={CreateProjectCss.inputgroup}>
            ...
            <input
              ...
              onChange={(e) =>
                setProjectData({
                  ...projectData,
                  shareable_links: e.target.value,
                })
              }
            />
          </div>
          ...
          <button
            className={CreateProjectCss.createbutton}

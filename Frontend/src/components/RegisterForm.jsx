...
const RegisterForm = () => {
  ...
  const handleTagChange = (selectedTag) => {
    if (!RegisterData.interests.includes(selectedTag)) {
      setRegisterData({
        ...RegisterData,
        interests: [...RegisterData.interests, selectedTag],
      });
    }
  };
  ...
  const handleRemoveTag = (tagToRemove) => {
    setRegisterData({
      ...RegisterData,
      interests: RegisterData.interests.filter((tag) => tag !== tagToRemove),
    });
  };
      ...
      <div className={registercss.mainroot}>
        <div className={registercss.wrapper}>
          <form onSubmit={handleSubmit}>
                ...
                {RegisterData.interests.map((tag, index) => (
                  <div key={index} className={registercss.tag}>
                    ...
                    <AiOutlineCloseCircle
                      className={registercss.removeicon}
            ...
            {registerdone && (
              <div className={registercss.additionalText}>
                <p

...
const CreateChannel = () => {
  ...
  const handleTagChange = (selectedTag) => {
    if (!ChannelData.tags.includes(selectedTag)) {
      setChannelData({
        ...ChannelData,
        tags: [...ChannelData.tags, selectedTag],
      });
    }
  };
  ...
  const handleRemoveTag = (tagToRemove) => {
    setChannelData({
      ...ChannelData,
      tags: ChannelData.tags.filter((tag) => tag !== tagToRemove),
    });
  };
    ...
    <>
      ...
      <div className={CreateChannelCss.wrapper}>
        <div className={CreateChannelCss.createprojectbox}>
              ...
              {ChannelData.tags.map((tag, index) => (
                <div key={index} className={CreateChannelCss.tag}>
                  ...
                  <AiOutlineCloseCircle
                    className={CreateChannelCss.removeicon}
          ...
          <button
            className={CreateChannelCss.createbutton}

        ...
        if (response.ok) {
          const updateProjects = async () => {
            setProject({
              ...projectData,
              title: ress.title,
              short: ress.shareable_links,
              description: ress.description,
              name: ress.project_holder,
              photos: ress.photos,
              like: ress.like,
              dislike: ress.dislike,
            });
          };
      ...
      <div className={ProjectPageCss.wrapper}>
        <div className={ProjectPageCss.leftsection}>
          ...
          <div className={ProjectPageCss.commentSection}>
            <textarea
              className={ProjectPageCss.comment_area}
